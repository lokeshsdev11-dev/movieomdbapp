...
A full-featured movie search application built with React that integrates with the OMDB API. Search for movies, view detailed information, and filter by type.
